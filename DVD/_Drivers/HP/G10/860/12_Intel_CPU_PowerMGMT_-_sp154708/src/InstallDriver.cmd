...
echo *powershell Install-ProvisioningPackage -PackagePath .\PPM-RPL-preview-v1003.20240522.ppkg  -QuietInstal >> "%DRV_Log%"
powershell Install-ProvisioningPackage -PackagePath .\PPM-RPL-preview-v1003.20240522.ppkg  -QuietInstal >> "%DRV_Log%" 2>&1
echo *xcopy /fhrkyiv ".\PPM.dll" "c:\windows\system32\drivers\" >> "%DRV_Log%"
xcopy /fhrkyiv ".\PPM.dll" "c:\windows\system32\drivers\" >> "%DRV_Log%" 2>&1
