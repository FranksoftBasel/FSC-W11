...
echo [%TIME%] Uninstallation process >> %APP_LOG%

Set curpath="%~dp0"
CD /D ""%curpath%""
UninstallTool.exe -silent

echo [%TIME%] Delete "Kavalan_Version.dll" from "C:\Windows\System32\drivers" >> %APP_LOG%
del /f C:\Windows\System32\drivers\Kavalan_Version.dll

echo [%TIME%] Delete "FwSwitchBin" from "C:\Windows\WWAN" >> %APP_LOG%
rmdir /s /q %windir%\WWAN\FwSwitchBin
