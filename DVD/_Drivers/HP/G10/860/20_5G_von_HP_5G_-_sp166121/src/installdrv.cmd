...
echo [%TIME%] Online injection >> %APP_LOG%

echo [%TIME%] Create Firmware folder >> %APP_LOG%
md "C:\Windows\WWAN\Firmware"

echo [%TIME%] Copy "FwPackage.flz" to "C:\Windows\WWAN\Firmware" >> %APP_LOG%
copy /y drivers\FwUpdateDriver\FwPackage.flz C:\Windows\WWAN\Firmware
...
echo [%TIME%] Copy "Kavalan_Version.dll" to "C:\Windows\System32\drivers" >> %APP_LOG%
copy /y .\Kavalan_Version.dll C:\Windows\System32\drivers
