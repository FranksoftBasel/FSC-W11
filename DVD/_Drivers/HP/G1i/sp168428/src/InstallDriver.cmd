...
rem echo *%windir%\system32\pnputil.exe /add-driver ".\JHI\*.inf" /install >> "%DRV_Log%"
rem pnputil.exe /add-driver ".\JHI\*.inf" /install >> "%DRV_Log%" 2>&1
rem if %errcode% equ 0 set errcode=%errorlevel%
rem if %errcode% equ 259 set errcode=0
...
rem Install ISSEI driver
rem echo *%windir%\system32\pnputil.exe /add-driver ".\ISSEI\WIN_ISSEI\*.inf" /install >> "%DRV_Log%"
rem pnputil.exe /add-driver ".\ISSEI\WIN_ISSEI\*.inf" /install >> "%DRV_Log%" 2>&1
rem if %errcode% equ 0 set errcode=%errorlevel%
rem if %errcode% equ 259 set errcode=0

rem Install ISSEI_EXT driver
rem echo *%windir%\system32\pnputil.exe /add-driver ".\ISSEI_extension\ISSEI_EXT\*.inf" /install >> "%DRV_Log%"
rem pnputil.exe /add-driver ".\ISSEI_extension\ISSEI_EXT\*.inf" /install >> "%DRV_Log%" 2>&1
rem if %errcode% equ 0 set errcode=%errorlevel%
rem if %errcode% equ 259 set errcode=0
