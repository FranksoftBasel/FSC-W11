...
set DRV_Title=DRV_Intel_Chipset
REM **************************************************************
...
REM **************************************************************
echo *xcopy /fhrkyiv ".\CSVer.dll" "c:\windows\system32\drivers\" >> "%DRV_Log%"
xcopy /fhrkyiv ".\CSVer.dll" "c:\windows\system32\drivers\" >> "%DRV_Log%" 2>&1
