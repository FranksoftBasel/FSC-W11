...
3. Locate the NPU Driver:
    - Expand the Neural processors section.
...
5. Install the Driver:
    ...
    - Select the .inf file and click Open - npu.inf
...
3.  Expand "Neural processors". The Intel(R) AI Boost or Intel(R) NPU should be listed. If not, the driver is not installed correctly.
...
1.  Right click "Start", select "Device Manager".
2.  In the "User Account Control" window, click "Yes".
3.  Expand "Neural processors" and double-click the Intel(R) NPU. In the "Driver" tab, note the Driver Version.
...
NPU-INSTALLATION CUSTOM SWITCHES
...
--nodrv Disables the driver installation step.
...
5. Scroll through the list and find "Intel(R) NPU Software & Drivers".
...
1.  Right click "Start", select "Device Manager".
2.  In the "User Account Control" window, click "Yes".
3.  For Intel(R) NPU Driver, expand "Neural processors".
4.  Right click the Intel(R) NPU Driver and select "Uninstall device".
