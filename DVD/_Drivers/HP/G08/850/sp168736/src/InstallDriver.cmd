...
cls
set version=1.05
set versiondrv="Keyboard 8.10.50.393 & HP Lan\Wlan driver 8.10.50.393"
set errcode=0

REM **************************************************************
REM DRV_Title - Avoid using space if possible
set DRV_Title=Hotkey_Support_Driver
REM **************************************************************
...
rem
echo *%windir%\system32\pnputil.exe /add-driver ".\*.inf" /subdirs /install >> "%DRV_Log%" 2>&1
