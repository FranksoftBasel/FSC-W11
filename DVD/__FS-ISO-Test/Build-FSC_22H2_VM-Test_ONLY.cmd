...
:: VM DBG
START /wait ULTRAISO -IN %ISO% -file %DP%\Autorun.inf -file %DP%\Autounattend.xml -file %DP%\bootmgr -file %DP%\bootmgr.efi -file %DP%\FS-Guzi-04.eXe -file %DP%\FSSysRep.Exe -file %DP%\RuckZuck.lnk -file %DP%\Setup.exe -file %DP%\Vcard.png -file "%DP%\Advanced Boot.lnk" -file "%DP%\VMware Tools.lnk" -file "%DP%\MediaCreationTool22H2.exe" -silent

:: Final
:: START /wait ULTRAISO -IN %ISO% -file %DP%\Autorun.inf -file %DP%\Autounattend.xml %DP%\Autounattend.cmd -file %DP%\bootmgr -file %DP%\bootmgr.efi -file %DP%\Setup.exe -file %DP%\Vcard.png -file "%DP%\Advanced Boot.lnk" -file "%DP%\RuckZuck.exe.lnk" -file "%DP%\VMware Tools.exe.lnk" -file "%DP%\MediaCreationTool22H2.exe" -silent
